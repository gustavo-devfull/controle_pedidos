      ...
      <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white border rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-gray-900">{currentProduct.unitPriceRmb ? `¥${currentProduct.unitPriceRmb}` : 'N/A'}</p>
                </div>
                <div>
                  <span className="text-sm font-medium text-gray-500">TOTAL RMB:</span>
                  <p className="text-gray-900">{currentProduct.totalRmb ? `¥${currentProduct.totalRmb}` : 'N/A'}</p>
                </div>
                <div>
            ...
            <div className="bg-white border rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-gray-900">{currentProduct.pesoUnitarioKg || 'N/A'}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{currentProduct.totalPesoLiq || 'N/A'}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{currentProduct.totalPesoBruto || 'N/A'}</p>
                </div>
                <div>
            ...
            <div className="bg-white border rounded-lg p-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{currentProduct.cbmTotal || 'N/A'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border rounded-lg p-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{currentProduct.eta || 'N/A'}</p>
                </div>
                <div>
            ...
            {/* Produto Vinculado */}
            {currentProduct.produtoExternoId && (
              <div className="md:col-span-2 lg:col-span-3 bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div>
                    <span className="text-sm font-medium text-green-700">REF Externa:</span>
                    <p className="text-green-900 font-semibold">{currentProduct.produtoExternoRef}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-green-700">Nome:</span>
                    <p className="text-green-900">{currentProduct.produtoExternoNome}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-green-700">Categoria:</span>
                    <p className="text-green-900">{currentProduct.produtoExternoCategoria}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-green-700">Preço:</span>
                    <p className="text-green-900">R$ {currentProduct.produtoExternoPreco}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-green-700">Estoque:</span>
                    <p className="text-green-900">{currentProduct.produtoExternoStock}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-green-700">Vinculado em:</span>
                    <p className="text-green-900">{currentProduct.vinculadoEm ? formatDate(currentProduct.vinculadoEm) : 'N/A'}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {/* Observações */}
            {(currentProduct.obs || currentProduct.obsPedido) && (
              <div className="md:col-span-2 lg:col-span-3 bg-white border rounded-lg p-4">
                ...
                <div className="space-y-4">
                  {currentProduct.obs && (
                    <div>
                      ...
                      <p className="text-gray-900 mt-1">{currentProduct.obs}</p>
                    </div>
                  )}
                  {currentProduct.obsPedido && (
                    <div>
                      <span className="text-sm font-medium text-gray-500">Observações do Pedido:</span>
                      <p className="text-gray-900 mt-1">{currentProduct.obsPedido}</p>
                    </div>
                  )}
                </div>
              </div>
